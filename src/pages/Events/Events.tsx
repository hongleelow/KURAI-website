    ...
    <div>
                  ...
                  className={`flex flex-col rounded-2xl p-7 transition-shadow hover:shadow-lg md:p-8 ${
                    category.dark
                      ...
                      : categoryIndex === 0 && eventIndex === 0
                        ? 'border-2 border-kurai-amber/25 bg-white shadow-sm'
                        : 'border border-kurai-ice bg-white shadow-sm'
                  }`}
                >
                  {/* Featured badge for next upcoming event */}
                  {categoryIndex === 0 && eventIndex === 0 && (
                    <span className="mb-3 inline-flex self-start rounded-full bg-kurai-amber/10 px-3 py-1 font-body text-xs font-semibold text-kurai-amber-dark">
                      Next Up
                    </span>
                  )}
                  ...
                  {/* Date badge */}
                  <div
                    className={`inline-flex items-center gap-1.5 self-start rounded-full px-3 py-1 font-body text-xs font-semibold uppercase tracking-wider ${
                      category.dark
                  ...
                  <p
                    className={`mt-2 flex-1 font-body text-sm leading-relaxed md:text-base ${
                      category.dark ? 'text-kurai-light-soft' : 'text-kurai-dark-60'
                    }`}
                  >
                    {event.description}
                  ...
                  {/* Register Button */}
                  <Link
                    to={`/contact?subject=${encodeURIComponent(event.title)}`}
                    className="mt-5 inline-flex items-center justify-center gap-2 rounded-lg bg-kurai-royal px-5 py-2.5 font-body text-sm font-semibold text-white transition-all hover:scale-105 hover:bg-kurai-dark"
                  >
                    Save My Spot
      ...
      <section className="relative overflow-hidden bg-kurai-royal px-6 py-20 text-white md:py-28">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          {nlStatus === 'success' ? (
            <div className="mx-auto mt-8 flex items-center justify-center gap-2 text-emerald-300">
            ...
            <form onSubmit={handleNewsletter} className="mx-auto mt-8 flex max-w-md gap-3">
              ...
              <button
                ...
                className="rounded-lg bg-white px-6 py-3 font-body text-sm font-semibold text-kurai-royal transition-all hover:scale-105 hover:bg-kurai-ice disabled:opacity-50"
              >
